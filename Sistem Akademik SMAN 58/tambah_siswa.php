	...
	<center>
		...
		<table>
			<tr>
				...
				<td>:</td>
				<td><input type="text" name="nis" id="nis" style="width: 180px; height: 30px;" required></td>
			</tr>
			...
			<tr>	
				...
				<td>:</td>
				<td><input type="text" name="nama" id="nama"style="width: 180px; height: 30px;" required></td>
			</tr>

			<tr>	
				<th style="text-align: left"><label for="ttl">Tanggal Lahir</label></th>
				<td>:</td>
				<td><input type="text" name="ttl" id="ttl"style="width: 180px; height: 30px;" required></td>
			</tr>

			<tr>	
				<th style="text-align: left"><label for="jk">Jenis Kelamin</label></th>
				<td>:</td>
				<td><input type="text" name="jk" id="jk"style="width: 180px; height: 30px;" required></td>
			</tr>

			<tr>	
				<th style="text-align: left"><label for="agama">Agama</label></th>
				<td>:</td>
				<td><input type="text" name="agama" id="agama"style="width: 180px; height: 30px;" required></td>
			</tr>

			<tr>	
				<th style="text-align: left"><label for="alamat">Alamat</label></th>
				<td>:</td>
				<td><input type="text" name="alamat" id="alamat"style="width: 180px; height: 30px;" required></td>
			</tr>
